...
# The package, so far (round 72, plans B1-B4): what a bend is, the pieces of
# the board, the cutters, the exact strip, the numbers. Everything below still
# waits for plans B3b, B5 and B6; the
