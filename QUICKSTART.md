...
- **Board edge colour** — цвет торца: `Same as board`, `Cream` или `Custom…`.
...
- **Body stitching** — как собрано тело платы. Действует только на
  ...
  Для двух последних справа стоит ряд квадратиков: медь, база, покров, адгезив,
  упрочнитель, паяльная маска. Клик по квадратику — выбор цвета.
- **Ignore soldermask layers** — исключить паяльную маску из платы; стек
  смыкается к ядру на убранную толщину.

**Silk options**
- Галочки **Top**/**Bottom**, цвет **White/Black**, режим
